...
public class DayPickerPagerAdapter extends PagerAdapter {
    ...
    public DayPickerPagerAdapter(@NonNull Context context, @LayoutRes int layoutResId,
        ...
        final TypedArray ta = context.obtainStyledAttributes(new int[]{android.R.attr.colorControlHighlight});
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        final int calendarMonth = mSelectedDay.get(Calendar.MONTH);
        if (mSelectedDay != null && calendarMonth == month) {
        ...
        final int mMinDateMonth = mMinDate.get(Calendar.MONTH);
        final int mMinDateYear = mMinDate.get(Calendar.YEAR);
        if (mMinDateMonth == month && mMinDateYear == year) {
        ...
        final int mMaxDateMonth = mMaxDate.get(Calendar.MONTH);
        final int mMaxDateYear = mMaxDate.get(Calendar.YEAR);
        if (mMaxDateMonth == month && mMaxDateYear == year) {
