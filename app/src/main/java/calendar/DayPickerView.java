...
//                R.styleable.CalendarView, defStyleAttr, defStyleRes);
        ...
        final String minDate = "01/01/1990";
        final String maxDate = "01/01/2030";
...
//        a.recycle();
        ...
        // Set up adapter.
        mAdapter = new DayPickerPagerAdapter(getContext(), R.layout.date_picker_month_item_material, R.id.month_view);
...
//        mAdapter.setDaySelectorColor(daySelectorColor);
        ...
        mViewPager = (DayPickerViewPager) findViewById(R.id.day_picker_view_pager);
...
//        }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        final boolean rtlDirection = ViewCompat.getLayoutDirection(this) == ViewCompat.LAYOUT_DIRECTION_RTL;
        if (rtlDirection) {
